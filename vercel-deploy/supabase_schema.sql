...
-- Create vector similarity index for embeddings (if pgvector is available)
...
-- Create functions for table creation (for the Python app)
...
CREATE OR REPLACE FUNCTION create_chunks_table()
RETURNS void AS $$
BEGIN
    -- Table already created above, this is just a placeholder
    RETURN;
...
CREATE OR REPLACE FUNCTION create_queries_table()
RETURNS void AS $$
BEGIN
    -- Table already created above, this is just a placeholder
    RETURN;
